...
function sendEmail({
    ...
    <div style="font-family: Arial; padding: 20px;">
      ...
      <p>${chartex_stats}</p>
      <a href="${tiktok_csv_url}" style="display:inline-block;margin-top:8px;padding:8px 16px;background:#4a90e2;color:white;border-radius:6px;text-decoration:none;">Download TikTok CSV</a>
